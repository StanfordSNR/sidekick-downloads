...
UdpQuacker* udp_quacker_new(size_t threshold, uint32_t freq_pkts, uint64_t freq_ms, const char* addr,
	uint8_t riblt, uint8_t optimistic_cache_policy, uint64_t reset_freq_ms);
...
uint8_t udp_quacker_awaiting_disc_ack(const UdpQuacker* quacker);
