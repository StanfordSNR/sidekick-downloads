...
# terrestrial link -> proxy at ground station: 50ms
# ground station -> LEO satellite -> ground station -> client last-mile: 25 ms + 10ms
NETWORK_SETTING_SAT = NetworkSetting(bw1=50, bw2=20, delay1=30, delay2=50, loss1=10, loss2=0)
NETWORK_SETTING_SAT_LONG = NetworkSetting(bw1=50, bw2=20, delay1=30, delay2=100, loss1=10, loss2=0)
NETWORK_SETTING_SAT_LONG_LONG = NetworkSetting(bw1=50, bw2=20, delay1=50, delay2=100, loss1=10, loss2=0)
NETWORK_SETTING_CELLULAR = NetworkSetting(bw1=50, bw2=20, delay1=10, delay2=30, loss1=10, loss2=0)
NS_LABELS = {"wifi": NETWORK_SETTING_WIFI, "sat": NETWORK_SETTING_SAT, "sat_long": NETWORK_SETTING_SAT_LONG, "sat_long_long" : NETWORK_SETTING_SAT_LONG_LONG, "cellular": NETWORK_SETTING_CELLULAR}
...
NETWORK_SETTING_SAT_MCAST = NetworkSetting(bw2=50, bw1=20, delay2=35, delay1=50, loss2=10, loss1=0)
...
# TODO change ending value to 0.03 or something (0.01 is TOO small)
scale_by = np.linspace(0.95, 0.01, 10)
scale_by = scale_by[:-1]
scale_by = list(scale_by)
scale_by.extend([0.05, 0.02, 0.016])
...
def ge_to_burst_size(ge_str):
    ...
    loss_bad = float(parts[2]) / 100.0
    loss_good = float(parts[3]) / 100.0
    if loss_bad == loss_good:
        return 1.0  # IID loss
    avg_bad_length = 1.0 / r
    return avg_bad_length