...
LABEL_MAP = {
    ...
    'picoquic_rtunnel_retx7': 'Encapsulated (LL) - Unordered',
    'picoquic_rtunnel_retx7_ordered32': 'Encapsulated (LL) - Ordered',
    'picoquic_rtunnel_retx7_bbr': 'Encapsulated (LL) - Unordered',
    'picoquic_rtunnel_retx7_ordered32_bbr': 'Encapsulated (LL) - Ordered',
    # Media
    'baseline': 'End-to-End',
    'baseline_rtunnel_retx7': 'Encapsulated (LL) - Unordered',
    'baseline_rtunnel_retx7_ordered32': 'Encapsulated (LL) - Ordered',
...
STYLE = {
    ...
    'Encapsulated (LL) - Ordered': PlotStyle(colors[3], linestyles[3]),
    'Encapsulated (LL) - Unordered': PlotStyle(colors[4], linestyles[4]),
